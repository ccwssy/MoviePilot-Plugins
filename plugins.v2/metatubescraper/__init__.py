                                ...
                                'content': [
                                    ...
                                    },
                                    {
                                        ...
                                        'content': [
                                            ...
                                            {'component': 'VRow', 'content': [{'component': 'VCol', 'props': {'cols': 12, 'md': 6}, 'content': [{'component': 'VSelect', 'props': {'model': 'translate_engine', 'label': '翻译引擎', 'items': [{'title': 'Google 免费', 'value': 'GoogleFree'}, {'title': 'Google 付费', 'value': 'Google'}, {'title': '百度', 'value': 'Baidu'}, {'title': 'DeepL', 'value': 'DeepL'}, {'title': 'OpenAI', 'value': 'OpenAi'}], 'hideDetails': True, 'density': 'compact'}}]}, {'component': 'VCol', 'props': {'cols': 12, 'md': 6}, 'content': [{'component': 'VTextField', 'props': {'model': 'translate_params', 'label': 'API Key', 'placeholder': 'Google免费留空，其他引擎填写对应Key', 'hideDetails': True, 'density': 'compact'}}]}]},
                                            {'component': 'VRow', 'content': [{'component': 'VCol', 'props': {'cols': 12}, 'content': [{'component': 'VAlert', 'props': {'type': 'info', 'variant': 'tonal', 'density': 'compact', 'class': 'mb-0'}, 'content': [
                                                {'component': 'div', 'props': {'style': 'padding: 2px 0'}, 'text': 'Google免费：留空'},
                                                {'component': 'div', 'props': {'style': 'padding: 2px 0'}, 'text': '百度：baidu-app-id=xxx,baidu-app-key=xxx'},
                                                {'component': 'div', 'props': {'style': 'padding: 2px 0'}, 'text': 'Google付费：google-api-key=xxx'},
                                                {'component': 'div', 'props': {'style': 'padding: 2px 0'}, 'text': 'DeepL：deepl-api-key=xxx'},
                                                {'component': 'div', 'props': {'style': 'padding: 2px 0'}, 'text': 'OpenAI：openai-api-key=xxx'},
                                            ]}]}]},
                                        ]
                                    }
                                ]
