                                ...
                                'content': [
                                    ...
                                    },
                                    {
                                        ...
                                        'content': [
                                            ...
                                            {'component': 'VRow', 'content': [{'component': 'VCol', 'props': {'cols': 12, 'md': 6}, 'content': [{'component': 'VSelect', 'props': {'model': 'translate_engine', 'label': '翻译引擎', 'items': [{'title': 'Google 免费', 'value': 'GoogleFree'}, {'title': 'Google 付费', 'value': 'Google'}, {'title': '百度', 'value': 'Baidu'}, {'title': 'DeepL', 'value': 'DeepL'}, {'title': 'OpenAI', 'value': 'OpenAi'}], 'hideDetails': True, 'density': 'compact'}}]}, {'component': 'VCol', 'props': {'cols': 12, 'md': 6}, 'content': [{'component': 'VTextField', 'props': {'model': 'translate_params', 'label': 'API Key', 'placeholder': 'baidu-app-id=xxx,baidu-app-key=xxx', 'hideDetails': True, 'density': 'compact', 'persistentHint': True, 'hint': 'Google免费留空。百度: baidu-app-id=ID,baidu-app-key=Key。Google: google-api-key=Key。DeepL: deepl-api-key=Key。OpenAI: openai-api-key=Key'}}]}]},
                                        ]
                                    }
                                ]
                            }]
